    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <div class="flex-second">
                ...
                <button class="recipe-flex" onclick="divVisibility('breakfast1')" id="breakfast"> Breakfast
                    <img src=".\images\break1.svg" style="margin-left:130px;"></button>
                <!--------script for breakfast--------->
                <button class="recipe-flex" onclick="divVisibility('lunch1')" id="lunch">
                    Lunch </button>
                <button class="recipe-flex" onclick="divVisibility('snacks1')" id="snacks">
                    Snacks</button>
                <button class="recipe-flex" onclick="divVisibility('dinner1')" id="dinner">
                    Dinner </button>
            ...
            <!---------breakfast tab------------>
            <br>
            <div id="breakfast1" style="width:100%">
                <!-- <div class="flex-fast"> -->
                <div class="title1">
...
for ($i=0;$i<4;$i++){
    ?>
                <div class="final" style="width:30%; display:inline-block">
                    <div class="flex-last">
                        <div class="recipe-area" id="recipe1" name="recipe1">
                            <div class="r-image" id="rimage" name="rimage" style="margin-left:10px;">
                                <img src=".\images\alooparatha.png"
                                    style="height:117px; width:220px; margin-left:15px;margin-right:15px;">

                            </div>
                            <div class="box-title">
                                <p id="recipename" name="recipename" style="margin-top:15px;">
                                    Name </p>
                            ...
                            <div class="box2">
                                ...
                                <!----clock image----->
                                <p id="timedisplay" name="timedisplay" style="margin-left:70px;">
                                    <?php echo '20:00';?> </p>

                            </div>
                            <div class="box3">
                                <img src=".\images\kcal.png" style="height:24px; width:20px; margin-left:15px;">&nbsp;
                                <span id="cal" style="font-size:13px;"> <?php echo $row['calories'];  ?> kcal
                                </span>
        ...
        <div id="snacks1">
            ...
            <div class="title1">
                <p id="tag-recipe" style="font-size:25px; font-weight:400; color:black;display:flex;"> Snacks
                </p>
                <p id="viewall"> view all </p>
            </div>
            ...
            <div class="flex-last">
                <div class="recipe-area" id="recipe1" name="recipe1">
                    ...
                    <div class="box2">
                        ...
                        <span id="one" style="font-size:10px;font-weight:400px;">Steps </span>
                        <!----clock image----->
                        <p id="timedisplay" name="timedisplay" style="margin-left:70px;"> <?php echo '20:00';?>
                        </p>
