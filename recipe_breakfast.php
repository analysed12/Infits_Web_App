...
<body>
    ...
    <div class="container1" style="margin-left:20px" id="myDIV1" onscroll="myFunction()">
        ...
        <div class="top-card" style=" background-color: #85B4A1;">
                ...
                <img src="./images/Picnic.png" class="imag im2 im2-2" style="left: -65px;bottom: -15px;height:70px">
        </div>
        </a>

        <a href="all_recipes.php" style="color: inherit;" class="lunch" id="btn2">
        <div class="top-card" style=" background-color: #db695f;">
                ...
                <h3 style="margin-right: 160px;color:#FFFFFF;font-weight: 400;margin-top:-7px;">All Recipe</h3>
                <p style="margin-right:130px;color: rgba(255, 255, 255, 0.9);margin-top:5px">Free menu planning<br/>to suit your needs</p>
                <img src="./images/Book.png" class="imag im2 im2-2" style="left: -45px;bottom: -15px;">
        </div>
        </a>
    ...
    <div class="category" style="display:flex;justify-content:flex-start;margin:20px;margin-right:1.5rem;">
