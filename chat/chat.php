							...
							<ul id="chatList" class="list-group mvh-50">
								<?php if (!empty($conversations)) { ?>
	    				          ...
	    				          align-items-center">
												<div class="d-flex
	    					            align-items-center">
													<img src="uploads/<?= $conversation['p_p'] ?>" class="rounded-circle" style="width:40px">
				...
				<div class="  d-inline-block p-2 flex-fill justify-content-between chat">
					...
					<div class="d-flex flex-row justify-content-between">
						<div class="d-flex  align-items-center">
							<img src="uploads/<?= $chatWith['p_p'] ?>" class="rounded-circle" style="width:50px">
									...
									if ($chat['from_id'] == $_SESSION['dietitian_id']) { ?>
										<?php if (substr($chat['message'], 0, 4) == "IMG-") { ?>
											...
											<p class="rtext align-self-end">
												...
												<img src="uploads/<?= $chat['message'] ?>" style="max-width: 250px">
