            ...
            <div class="container1_leftside">
                ...
                <form action="<?php $_SERVER['PHP_SELF']?>" method="POST">
                    <div class="search_client">
                        <div><button id="btn1" type="submit" name="searching_btn"><span
                                    class="material-symbols-outlined">search</span></button> </div>
                        <div> <input type="text" name="search_client_name" oninput=""
                                id="search_bar" placeholder="Search Clients" class="seach_clients_text"
            ...
            <div class="container1_rightside">
                ...
                const renderCalendar = () => {
                    let firstDayofMonth = new Date(currYear, currMonth, 1).getDay(), // getting first day of month
                        lastDateofMonth = new Date(currYear, currMonth + 1, 0)
                        .getDate(), // getting last date of month
                        lastDayofMonth = new Date(currYear, currMonth, lastDateofMonth)
                ...
                prevNextIcon.forEach(icon => { // getting prev and next icons
                    icon.addEventListener("click", () => { // adding click event on both icons
                        ...
                        if (currMonth < 0 || currMonth >
                            11) { // if current month is less than 0 or greater than 11
...
$off = array();
if ($name == 2) {
    $sql = "SELECT * FROM `goals` WHERE dietition_id = 'John_wayne' AND client_id=2";
} else {
