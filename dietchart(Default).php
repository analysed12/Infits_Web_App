...
<body>
  ...
  <div class="main-content">
    <div> 
      <div class="left"> 
        <h1 style="margin-left:-30px;margin-top:10px;margin-bottom:-0.7rem !important;font-size:40px">Diet Chart</h1> 
        <h1 style="margin-left:-30px;color: #CBCBCB;margin-bottom:-0.9rem !important;font-size:33px;">Ronald Richards</h1> 
    ...
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;margin-top:30px;">
      <img src="images/dietchart.svg" class="image">
      <p style="font-size:33px;width:344px;text-align:center;" class="para">You haven't created any chart yet!</p> 
      
    </div>
 <a href="dietchart1.php" style="backgrounf:none">   <div style="display:flex !important;flex-direction:row !important;width:284px;height:97px;background: #FFFFFF;box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.25);border-radius: 50px !important;align-items:center;justify-content:center;position:absolute;bottom:30px;right:30px;margin:20px;" class="btns">
