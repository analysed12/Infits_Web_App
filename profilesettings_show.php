...
<body>
    ...
    <h1 style="font-size:40px;fontweight:400;padding-bottom:1rem">Profile Settings</h1>
        <div class="maincontainer_wrapper">
            ...
            <div>   
            <img src="images/Profile_dp.svg" style="border-radius:25px;" />
                <div style="display:flex;align-items:center;justify-content:center;gap:0.5rem;padding-top:1rem;" >
                    <img src="images/Star.svg" style="background:none">
        ...
        <div class="footer">
            <a href="profilesettings_edit.php" class="editbutton">Edit Profile Details</a>
...
<div id="popup1" class="overlay">
	<div class="popup">
        ...
        <h5>Share Via <img src="images/shareeee.png" ></h5>
