...
<body>
    <div class="live_call">
        <div class="livecall_leftside">
            ...
            <div style="margin-top:1rem"><img src="images/ronald.png"class="pic_live"></div>
            <a href="#popup1"><div style="float:right"><button class="btn_endlive">End Live Video</button></div></a>
