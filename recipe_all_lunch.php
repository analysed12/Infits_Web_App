...
<body>
    <div class="header" style="align-items:center;">
        <div class="title"style="font-size:48px;margin-left:3rem;margin-top:1.2rem; ">Recipes <small style="color: #787885; font-size:20px; margin-left:1rem;">All Lunch Recipes</small></div>
