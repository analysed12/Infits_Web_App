            ...
            <div class="sform">
                ...
                <div class="form_inputs">
                    ...
                    <div class="ip_box">
                        ...
                        <input class="input_bar" name="dietitianuserID" id="username" type="text" placeholder="Username">
                    </div>
                    <div class="ip_box">
                        <img src="images/account_name.svg" alt="">
                    ...
                    <div class="ip_box">
                        ...
                        <input class="input_bar" name="password" id="password" type="text" placeholder="       Password">
                    </div>
                    <div class="ip_box">
                        <img src="images/shield.svg" alt="">
                        <input class="input_bar" name="password_2" id="retype_password" type="text" placeholder="       Confirm Password">
                    </div>
                    <div class="check">
                        <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                        <label for="vehicle1"> I've read and agree with Terms and Services <br>and the Privacy Policy of
                            INFITS </label>
                    </div>
                    <div class="sign_btn_section">
                        ...
                        <div class="sign_in_sec">
                            ...
                            <a href="login.php"></a><div>Sign In</div></a>
                        </div>
                    </div>
                </div>
            </div>
