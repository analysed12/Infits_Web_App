        ...
        <div class="col-lg-4 tst-right">
            <div class="set-goal">
                ...
                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                    ...
                    <input name="setgoal" value="<?=$progressBarData[0]['weight']?>" required min="1" type="number" id="set-goal" placeholder="00000 BPM">
...
?>
                    <div class="activity-box">
                        ...
                        <div class="activity-data">
                            <span class="up"><?php echo (ucwords($pastActivityData[$k]['weight'])) ?>KG</span>
