                ...
                <div id="inner11">
                    <div class="flex-container">
                        ...
                        <a href="track_stats_steps.php">
                            <i style="color:#FF6C6CCA ;rotate: -90deg;" class="fa-solid fa-shoe-prints" ></i>
                        ...
                        <div class="client-card" style="color:#6844E2; border: 1px solid #6844E2;">
                        <a href="track_stats_sleep.php">
                            <i style="color:#6844E2;" class="fa-solid fa-moon"></i>
                            <p style="color:#6844E2;">Sleep</p>
                        </a>
                        </div>
