...
<body>
    ...
    <p class="header" style="font-size:40px;margin-left:3.3rem;margin-top:2.5rem">Edit Plan</p>
        ...
        <div class="plan_form">
            ...
            <div class="ev-img" style="position:relative">
                    ...
                    <img src="images/create_edit_plan.svg" class="edit-plan-img" style="position:absolute;margin-top:2rem; z-index:-2; width: 140px;
                    height: 133px;">
                </div>
            </div>
            <br>
...
<!----------------------------------PLAN DURATION------------------------------------------------------------------>
                        ...
                        <div class="features_main">
                            <div class="features_left textbox-wrapper">
                                <div class="input-group"><div class="features_box"><input type="text" name="text_arr[]" value="<?php echo $row['features']?>" /><button type="button" class="remove-textbox"><i class="fa-solid fa-xmark"></i></button></div></div>
                            </div>
                            <div class="features_right">
                                <!-- <button type="button" class="plan_btn_add plan_btn add-textbox">
                                    +
                                </button> -->
                                <button type="button"                                   style="float:right; display: flex;
                                justify-content: center; align-items: center;width:40px; height: 40px; border:none; text-align: center;"
