...
<body>
    ...
    <div id="content">
        ...
        <div class="plan_form">
            ...
            <br>
            <form action="myplan.php" method="post">
                <!-- Plan name -->
                <div style="text-align:center; !important" class="plan_name_box">
                    <input type="text" placeholder="Plan Name" class="plan_name" name="plan_name" required>
                </div>
                ...
                <div class="event_form">
                    <div class="evt-form">
                        ...
                        <input class="subject subject-text" type="date" name="start_date" style="height: 45px; background: #FFFFFF;
    box-shadow: 0px 1.7px 5px rgba(0, 0, 0, 0.25);
    border-radius: 10px;
    border:none;" />
                        <p style="font-size:15px; margin-top:10px;">End Time</p>
                        <input class="subject subject-text" type="date" name="end_date" style="height: 45px; background: #FFFFFF;
    box-shadow: 0px 1.7px 5px rgba(0, 0, 0, 0.25);
    border-radius: 10px;
    border:none;" />
                        <br>
                        ...
                        <input class="subject " type="text" name="description" style="height: 79px;  background: #FFFFFF;
    box-shadow: 0px 1.7px 5px rgba(0, 0, 0, 0.25);
    border-radius: 10px;
    border:none;" />
                        <br />
                        ...
                        <input class="subject subject-text" type="number" name="price" placeholder="Rs. /month" style="height: 45px; background: #FFFFFF;
    box-shadow: 0px 1.7px 5px rgba(0, 0, 0, 0.25);
    border-radius: 10px;
    border:none;" />
