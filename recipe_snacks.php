...
<body>
    ...
    <div class="header" style="">
        ...
        <h2 style="margin-left:4rem;margin-top:1rem;font-weight:400;font-size: 40px;">Recipes</h2>
            <h4 style="margin-left:30px;color:#787885;font-size: 23px;margin-top:2.2rem;">Snacks</h4>
        </div>
    ...
    <!-- <div class="category" style="display:flex;justify-content:flex-start;margin:20px;margin-right:30px;">
        ...
        <div class="filter-outline" style="display:flex; justify-content:space-between; align-items:center; margin:10px; margin-left:55px;padding-top:1px;padding-bottom:1px;">
            ...
            <img class="filter-line"  src="./images/image 3.png" style="padding-left:5px" alt="">
        </div>
        ...
        <div class="filter-outline" style="display:flex; justify-content:space-between; align-items:center; margin:10px; margin-left:20px;">
            ...
            <img class="filter-line"  src="./images/image 5.png" alt="">
        </div>
        <div class="filter-outline" style="display:flex; justify-content:space-between; align-items:center; margin:10px; margin-left:20px;">
            <div class="filter-text">Crepes</div>
            <img class="filter-line"  src="./images/image 6.png" alt="">
        </div>
        <div class="filter-outline" style="display:flex; justify-content:space-between; align-items:center; margin:10px; margin-left:20px;">
            <div class="filter-text">Juice</div>
            <img class="filter-line" src="./images/image 7.png" alt="">
        </div>
        <div class="filter-outline" style="display:flex; justify-content:space-between; align-items:center;margin:10px;margin-left:20px;">
    ...
    <div class="middle_wrapper" style="display:flex;justify-content:space-between;margin-top:20px;margin-left:5rem;margin-right:2.5rem">
        ...
        <a href="recipe_all_snacks.php"><h3 style="color:#6A6A6A;font-size:20px; margin-right: 50px;">View All</h3></a>
    </div>
