...
?>
        ...
        <p style="margin:auto;font-size:33px;display:flex;text-align:center;align-items:center;justify-content:center;">No tasks created yet!</p>
        <!-- <div class="button"><button type="btn" class="btn" style="">
    <p>Create Task</p>
