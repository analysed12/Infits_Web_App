        ...
        <div class="dashboard_container4">
            ...
            <div class="container4_wrapper1">
                ...
                <div class="symbols-container col-12">
                    <div class="symbols col-2"><img src="images/steps.svg" style=""><span>Steps</span></div>
                    <div class="symbols col-2"><img src="images/heart.svg" style="width:1.8rem"><span>Heart Rate</span></div>
                    <div class="symbols col-2"><img src="images/water.svg" style="width:1.8rem"><span>Water</span></div>
                    <div class="symbols col-2"><img src="images/sleep.svg" style="width:1.8rem"><span>Sleep</span></div>
                    <div class="symbols col-2"><img src="images/weight.svg" style="width:1.8rem"><span>Weight</span></div>
                    <div class="symbols col-2"><img src="images/calories.svg" style="width:1.8rem"><span>Calories</span></div>
                </div>
            </div>
            <?php
            if(!empty($data)){
