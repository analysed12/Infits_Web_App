...
@media only screen and (max-width: 767px) {
  ...
  <div id="page">
    ...
    <div class="help-box">
      ...
      <img src="images/faq.png" style="margin-right:20px ;margin-left:20px ; height: 48px">
      <div class="help-text">
        <p style="font-size: 25px; margin: 0;color:#000000;">FAQs 
          <br> 
    ...
    <div class="help-box">
      <div class="help-content">
      <img src="images/email.png" style="margin-right:20px ;margin-left:20px ; height: 48px;">
      <div class="help-text">
        
        <p style="font-size: 25px; margin-left: 10px; margin: 0;color:#000000;">EMAIL
          <br> 
