...
<body>
    ...
    <?php
      ...
      if(isset($_POST['add']) || isset($_POST['add-more']) || isset($_FILES['my_image']))
      {
...
if (isset($_POST['save'])){
                        $ingrd=$_SESSION['id'] ;  
              $query11 = "SELECT * FROM `add_ingredient` WHERE ingrd_id='$ingrd'";
   ...
   $var = $_SESSION['receipe_id'];
    ...
    <div style="height:420px;display:inline-block;float:right;margin-right:100px">
           ...
           $path = $ext[1];
            ...
            <li>
                <div class="img-display"
                    style="margin-left:20px;height:5px; width:5px; border-radius:50%;display:inline;">
                    <img src="<?php echo $path;?>" alt="" title="<?php $ext[0];?>"
