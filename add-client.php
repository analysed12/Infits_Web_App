...
<body>
    <div class = "container-sm">
        ...
        <div id="myDIV" class ="box">
            <button onclick = "window.location.href ='http://localhost:8080/task-3/add-client/add-client.php';" class="btn current" style="margin-left:70px;margin-right:237px;"> Send Requests </button>
            <button onclick = "window.location.href ='http://localhost:8080/task-3/add-client/pendingreq.php';" class="btn" style="margin-right:200px;"> Pending Requests </button>
            <button onclick = "window.location.href ='http://localhost:8080/task-3/add-client/accepted-req.php';" class="btn"> Accepted Requests </button>
        </div>
