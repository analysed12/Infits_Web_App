...
<body>
    <div class = "container-sm">
        ...
        <div id="myDIV" class ="box">
            ...
            <button onclick = "window.location.href ='http://localhost:8080/task-3/task-4/pendingreq.php';" class="btn current" style="margin-right:200px;"> Pending Requests </button>
            <button onclick = "window.location.href ='http://localhost:8080/task-3/task-4/accepted-req.php';"class="btn"> Accepted Requests </button>
        </div>
        ...
        <div class = "forms">
                ...
                <p style="color: #CACACA; padding-right:100px;"> Dec 23, 2022   18:52 </p>
                <button class = "accept" href ="#" type ="submit">Accept</button>
        </div>
        <div class = "forms">
                <img class="profile-icon" src = "icons/profile-icon.svg" alt = "userprofile"></img>
                <p style="padding-right:80px;"> Ronald Richards </p>
